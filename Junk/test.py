...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 25 17:55:31 2019
...
Diffu  =  lambda z : 0.002*np.cos(2.51327412287183*z) + 0.003
dKdz   =  lambda z : -0.00502654824574367*np.sin(2.51327412287183*z)
Beta   =  lambda z : np.sqrt(0.004*np.cos(2.51327412287183*z) + 0.006)
dBdz   =  lambda z : -0.00502654824574367*np.sin(2.51327412287183*z)/np.sqrt(0.004*np.cos(2.51327412287183*z) + 0.006)
ddBdzz =  lambda z : -(0.0126330936333944*np.cos(2.51327412287183*z) + 2.52661872667888e-5*np.sin(2.51327412287183*z)**2/(0.004*np.cos(2.51327412287183*z) + 0.006))/np.sqrt(0.004*np.cos(2.51327412287183*z) + 0.006)
Alpha  =  lambda z : -0.00502654824574367*np.sin(2.51327412287183*z)
dAdz   =  lambda z : -0.0126330936333944*np.cos(2.51327412287183*z)
ddAdzz =  lambda z : 0.031750427320627*np.sin(2.51327412287183*z)
dABdz  =  lambda z : -0.0126330936333944*np.sqrt(0.004*np.cos(2.51327412287183*z) + 0.006)*np.cos(2.51327412287183*z) + 2.52661872667888e-5*np.sin(2.51327412287183*z)**2/np.sqrt(0.004*np.cos(2.51327412287183*z) + 0.006)
#%%
#######
#Euler#
#######
